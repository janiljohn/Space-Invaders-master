...
class Laser(Sprite):   # TODO -- change to use YOUR OWN IMAGES for ship, alien lasers
    ...
    alien_laser_images = [pg.transform.rotozoom(pg.image.load(f'spaceInvaders_start/images/alienlaser{n}.png'), 0, 1) for n in range(2)]
    ship_laser_images = [pg.transform.rotozoom(pg.image.load(f'spaceInvaders_start/images/laser_{n}.png'), 0, 1) for n in range(2)]
